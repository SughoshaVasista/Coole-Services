"""
Django settings for edunet_pro project.
...
WSGI_APPLICATION = 'edunet_pro.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'coole_db'),
        'USER': os.environ.get('DB_USER', 'sughosha'),
        'PASSWORD': os.environ.get('DB_PASSWORD', 'sughosha_12'),
